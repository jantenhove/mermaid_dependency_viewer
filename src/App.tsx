  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 flex flex-col font-sans">
      ...
      <main className="flex-1 flex flex-col lg:flex-row overflow-hidden h-[calc(100vh-64px)]">
        {/* Left Panel: Editor */}
        <div className="w-full lg:w-1/3 flex flex-col border-r border-slate-800 bg-slate-900/50">
          ...
          <textarea
            className="flex-1 w-full bg-slate-950 p-4 font-mono text-sm resize-none focus:outline-none focus:ring-1 focus:ring-blue-500/50"
            value={input}
